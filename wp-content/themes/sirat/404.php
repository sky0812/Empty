...
<div class="not container">
	<main id="content" role="main">
		...
		<div class="more-btn">
	        <a href="<?php echo esc_url(home_url()); ?>"><?php echo esc_html(get_theme_mod('sirat_404_page_button_text',__('Go Back','sirat')));?><span class="screen-reader-text"><?php esc_html_e( 'Go Back','sirat' );?></span></a>
	    </div>
