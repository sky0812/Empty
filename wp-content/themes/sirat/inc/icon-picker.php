...
class Sirat_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $sirat_font_awesome_icon_array = sirat_font_awesome_icon_array();
                    foreach ($sirat_font_awesome_icon_array as $sirat_font_awesome_icon) {
                            $icon_class = $this->value() == $sirat_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($sirat_font_awesome_icon).'"></i>
                            <span class="sirat-social-class">'.esc_attr($sirat_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function sirat_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'sirat-customizer-script', get_template_directory_uri().'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'sirat_customizer_script' );

if(!function_exists('sirat_font_awesome_icon_array')){
    function sirat_font_awesome_icon_array(){
