...
Tags: crypto, cryptocurrency, coinmarketcap, ticker, bitcoin, coingecko, cryptocompare, crypto widgets, cryptocurrency widgets, cool plugins, blockchain, coins
...
== Description ==
**Cryptocurrency Widgets** WordPress plugin generates **crypto coins** price widgets & coins list shortcodes – bitcoin, litecoin, ethereum, ripple, dash etc. It supports **coingecko.com** API. You can create multiple **crypto widgets** designs:- price label, crypto list widget, multi-currency tabs widget and a becautiful crypto price ticker.
...
https://www.youtube.com/watch?v=O7jLqDMsfHE
